...
public class DailyCalendar extends BaseCalendar {
     ...
     *                          time range
     */
    public DailyCalendar(com.ullink.rxscheduler.cron.calendar.Calendar baseCalendar,
     ...
     * <code>{@link TimeZone#getDefault()}</code> time zone unless an explicit 
     * time zone is set via <code>{@link BaseCalendar#setTimeZone(TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(com.ullink.rxscheduler.cron.calendar.Calendar, java.util.TimeZone, long, long)}</code>
