 ...
 * do not define actual fire times, but rather are used to limit a <code>Trigger</code> from firing on its normal schedule if necessary. Most
 * Calendars include all times by default and allow the user to specify times
 * to exclude.
 * <p>
 * As such, it is often useful to think of Calendars as being used to <I>exclude</I> a block of time - as opposed to <I>include</I> a block of time. (i.e. the schedule &quot;fire every five minutes except on Sundays&quot; could be
 ...
 */
public interface Calendar extends java.lang.Cloneable
{
    ...
    /**
     * <p>
     * Set a description for the <code>Calendar</code> instance - may be useful for remembering/displaying the purpose of the calendar, though the description has no meaning to Quartz.
     * </p>
     */
