 ...
 * </p>
 * <p>
 * Regarded as base functionality is the treatment of base calendars. Base calendar allow you to chain (stack) as much calendars as you may need. For example to exclude weekends you may use WeeklyCalendar. In order to exclude holidays as
 * well you may define a WeeklyCalendar instance to be the base calendar for HolidayCalendar instance.
 * </p>
 * @see com.ullink.rxscheduler.cron.calendar.Calendar
 * @author Juergen Donnerstag
 * @author James House
 */
public class BaseCalendar implements Calendar, Cloneable
{
